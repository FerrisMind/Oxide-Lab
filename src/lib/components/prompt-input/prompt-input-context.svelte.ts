...
export class PromptInputController {
    ...
    constructor(
        ...
        this.attachments = new AttachmentsController(accept, multiple, maxFiles, maxFileSize, onError);
    }
...
export function getPromptInputController(): PromptInputController {
    ...
    if (!context) {
        throw new Error('Wrap your component inside <PromptInputProvider> to use getPromptInputController().');
    }
    return context;
}
...
export function getPromptInputAttachments(): AttachmentsController {
    ...
    if (!context) {
        throw new Error('getPromptInputAttachments must be used within a PromptInput or PromptInputProvider');
    }
    return context;
}
...
export function getProviderAttachments(): AttachmentsController {
    ...
    if (!context) {
        throw new Error('Wrap your component inside <PromptInputProvider> to use getProviderAttachments().');
    }
    return context;
}
