import type { HTMLAttributes, HTMLButtonAttributes, HTMLTextareaAttributes, HTMLFormAttributes } from 'svelte/elements';
...
export interface PromptInputProps extends Omit<HTMLFormAttributes, 'onsubmit'> {
...
export interface PromptInputButtonProps extends HTMLButtonAttributes {
    variant?: 'default' | 'outline' | 'ghost';
    size?: 'default' | 'sm' | 'icon-sm';
    children?: import('svelte').Snippet;
}

export interface PromptInputAttachmentsProps extends Omit<HTMLAttributes<HTMLDivElement>, 'children'> {
...
export interface PromptInputSubmitProps extends HTMLButtonAttributes {
