...
<div class="gguf-upload-area">
  <div class="file-row">
    <div class="input-with-button">
      ...
      <button class="inside-btn" type="button" onclick={pickModel} aria-label="Выбрать файл модели" draggable="false">
        <Binoculars size={16} weight="bold" />
      </button>
    </div>
    <button class="primary" onclick={mainAction} disabled={$chatState.busy} title="Загрузить/Выгрузить" draggable="false">
