...
declare module 'phosphor-svelte' {
  import type { SvelteComponentTyped } from 'svelte';
  export class GearSix extends SvelteComponentTyped<{
    size?: number | string;
    weight?: string;
    style?: string;
  }> {}
  export class UploadSimple extends SvelteComponentTyped<{
    size?: number | string;
    weight?: string;
    style?: string;
  }> {}
  export class PaperPlaneRight extends SvelteComponentTyped<{
    size?: number | string;
    weight?: string;
    style?: string;
  }> {}
  export class ChatsCircle extends SvelteComponentTyped<{
    size?: number | string;
    weight?: string;
    style?: string;
  }> {}
  export class ArrowSquareOut extends SvelteComponentTyped<{
    size?: number | string;
    weight?: string;
    style?: string;
  }> {}
