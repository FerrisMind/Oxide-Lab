<script lang="ts">
  ...
  // Текущие параметры генерации (можно интегрировать с глобальным состоянием)
  let currentParams = $state<GenerationParams>({
    temperature: 0.7,
  ...
  function handleApplyPreset(params: GenerationParams) {
    console.log('Preset applied:', params);
    // Здесь можно интегрировать с глобальным состоянием чата
  }
</script>
...
<div class="performance-page">
  ...
  <div class="performance-layout">
    <!-- Левая панель - метрики и мониторинг памяти -->
    <main class="metrics-panel">
      <PerformanceMetrics />
      <MemoryMonitor />
    </main>
    
    <!-- Правая панель - пресеты параметров -->
    <aside class="presets-panel">
      <ParamPresets bind:currentParams onApplyPreset={handleApplyPreset} />
      ...
      <div class="info-card">
        ...
        <div class="info-section">
          ...
          <p>
            Время от начала генерации до появления первого токена. Критически важно для 
            отзывчивости пользовательского интерфейса.
          </p>
          <p class="target-info">
        ...
        <div class="info-section">
          ...
          <p>
            Количество токенов, генерируемых в секунду после начала генерации. 
            Влияет на общее время получения ответа.
          </p>
          <p class="target-info">
        ...
        <div class="info-section">
          ...
          <p>
            Общее время инициализации и загрузки модели в память. Включает загрузку 
            весов, инициализацию токенизатора и подготовку устройства.
          </p>
          <p class="target-info">
        ...
        <div class="info-section">
          ...
          <p>
            Объем RAM/VRAM, используемый загруженной моделью. Критично для 
            стабильности работы и возможности запуска на различных устройствах.
          </p>
          <p class="target-info">
