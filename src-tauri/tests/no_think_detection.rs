...
fn detect_no_think_simple() {
    let r = GenerateRequest { prompt: "Hello <think>hidden</think> world".to_string(),
        use_custom_params: false, temperature: None, top_p: None, top_k: None, min_p: None, repeat_last_n: 0, repeat_penalty: None, seed: None };
