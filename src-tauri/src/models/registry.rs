...
pub fn get_model_factory() -> &'static ModelFactory {
    MODEL_FACTORY.get_or_init(|| {
        ...
        factory.register_builder(crate::models::common::builder::ModelBuilder::Qwen3(
            Qwen3ModelBuilder::new(),
        ));
        // Register Gemma3 builder
        factory.register_builder(crate::models::common::builder::ModelBuilder::Gemma3(
            Gemma3ModelBuilder::new(),
        ));
